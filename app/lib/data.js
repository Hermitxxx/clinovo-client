// get all doctors
export async function getDoctors(authHeader) {
    const res = await fetch(`http://localhost:5000/doctors`, authHeader)
...
export async function getTopDoctors(authHeader) {
    const res = await fetch(`http://localhost:5000/top-doctors`, authHeader)
    const data = await res.json()
    return data
}
